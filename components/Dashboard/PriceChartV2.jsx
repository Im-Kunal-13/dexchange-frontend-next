...
import { buildCandleStickData } from "../../utility"
...
const PriceChartV2 = () => {
    ...
    return (
        <div className="w-full border-b border-white border-opacity-10 h-fit bg-bgSidebarGray1">
            <HighchartsReact
                containerProps={{ style: { height: "430px", padding: "24px" } }}
