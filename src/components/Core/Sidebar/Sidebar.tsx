...
export const Sidebar = () => {
    ...
    const { sidebarToggleCollapse, setSidebarToggleCollapse } = useAppUiStore()
    ...
    const wrapperClasses = classNames(
        "h-screen pt-1 bg-bgSidebarGray1 border-r border-r-white border-opacity-10 max-h-screen flex justify-between flex-col transition-all duration-300 absolute left-0 z-20",
        {
                                ...
                                <Link href={menu.link}>
                                    <a className={getNavItemLinkClasses(menu)}>
                                        ...
                                        >
                                            ...
                                            {menu.label === "Settings" && (
                                                <span
                                                    className={`ml-5 rounded-full w-2.5 h-2.5 inline-block text-xs text-white ${
                                                        menu.link ===
                                                        router.pathname
                                                            ? "bg-red1"
                                                            : "bg-purple1"
